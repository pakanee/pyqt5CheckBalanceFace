...
"background-image: url(:/image/TCMLOGO.jfif);")
        ...
        self.label_PersonName = QLabel(self.centralwidget)
        self.label_PersonName.setObjectName(u"label_PersonName")
        self.label_PersonName.setGeometry(QRect(230, 110, 131, 21))
        ...
        self.tableView_transection = QTableView(self.gridLayoutWidget)
        self.tableView_transection.setObjectName(u"tableView_transection")
        ...
        self.lineEdit_MedicalRemaining = QLineEdit(self.centralwidget)
        self.lineEdit_MedicalRemaining.setObjectName(u"lineEdit_MedicalRemaining")
        self.lineEdit_MedicalRemaining.setGeometry(QRect(670, 220, 211, 41))
        self.lineEdit_RemainLeave = QLineEdit(self.centralwidget)
        self.lineEdit_RemainLeave.setObjectName(u"lineEdit_RemainLeave")
        self.lineEdit_RemainLeave.setGeometry(QRect(230, 220, 211, 41))
        ...
        self.lineEdit_MedicalExpenses.setGeometry(QRect(450, 220, 211, 41))
    ...
    def retranslateUi(self, CheckBalance):
        ...
        self.label_PersonName.setText(QCoreApplication.translate("CheckBalance", u"Person Name ", None))
