        ...
        try:
            ...
            for some_variable in json_data['AcsEvent']['InfoList']:
                if some_variable['time']=='2021-07-19T16:50:42+07:00':
                    ...
                    row = cursor.fetchone() 
                    while row: 
                        self.label_AmountCanUse.setText(str(row[0]))
                        self.lineEdit_cardNo.setText(row[1])
                        self.lineEdit_PersonNo.setText(row[2])
                        self.lineEdit_PersonName.setText(row[3])
                        self.lineEdit_DepartMent.setText(row[4])
                        self.lineEdit_personLeave.setText('10')
                        self.lineEdit_MedicalExpenses.setText('0')
                        self.lineEdit_RemainingLeave.setText('0')
